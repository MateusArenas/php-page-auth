            ...
            <div class="col-12 col-md-6">
              <div class="row justify-content-end px-4">
                  <span style="box-sizing:border-box;display:inline-block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:relative;max-width:100%">
                    ...
                    <img alt="image-profile" src="<?php echo getimagebasepath("/images/banner.png"); ?>" decoding="async" data-nimg="intrinsic" class="img-fluid rounded" style="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:65%;max-height:100%" >
                  </span>
              </div>
            </div>
        </div>
