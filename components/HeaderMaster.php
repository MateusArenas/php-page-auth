...
?>
      <header class="sticky-top">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a href="index.php" class="navbar-brand text-muted">php-example</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
                </button>
                <div class="navbar-collapse collapse mt-2 mt-lg-0" id="navbarToggleExternalContent">
                    ...
                    <div class="navbar-nav"><a href="signin.php" data-rr-ui-event-key="#deets" class="nav-link me-2">Sign In</a>
                    <a href="signup.php" data-rr-ui-event-key="2" class="btn my-2 my-lg-0 btn-outline-light">Sign Up</a></div>
                </div>
            </div>
